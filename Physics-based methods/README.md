...
### Overview
The physics module predicts protein–ligand binding free energies using alchemical simulations (e.g., FEP) and two-point methods (e.g., MM/GBSA, MM/PBSA) using GROMACS program.
